<div class="row">
  <div class="form-group col-md-3 col-xs-6">
    <?php echo e(Form::label('linea','Linea')); ?><?php echo e(Form::select('linea', ['A'=>'A','B'=>'B'], null, ['class'=>'form-control'])); ?>
  ...
  <div class="form-group  col-md-3 col-xs-6">
    <?php echo e(Form::label('nivelsilo','Nivel del silo de fango humedo')); ?> <?php echo e(Form::number('nivelsilo',null,['class'=>'form-control'])); ?>
