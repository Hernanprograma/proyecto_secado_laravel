                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <?php if(isset($marcha_centrifuga->user->name)): ?><?php echo e($marcha_centrifuga->user->name); ?>
                                  ...
                                  <?php endif; ?></td>
                                    ...
                                    <?php if($marcha_centrifuga->estado == "En Marcha"): ?>
                                    <td style="background-color:green"><?php echo e($marcha_centrifuga->estado); ?></td>
                                    <?php else: ?>
                                    <td style="background-color:red"><?php echo e($marcha_centrifuga->estado); ?></td>
                                    <?php endif; ?>
